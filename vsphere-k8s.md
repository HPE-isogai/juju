...
## Install Machines
```
  hostname            IP                                cpu   mem   disk    GPU     description
  ------------------- --------------------------------- ----- ----- ------- ------- --------------------------
  ubu-gw-ext          15.210.188.130/22, 10.0.0.0/16 dhcp   2     4     40GB    None    Juju controller/dhcp/dns
  (juju controller)   10.0.0.0/16 dhcp                  4     16    100GB   None    K8s Master
  (juju k8s\#1)       10.0.0.0/16 dhcp                  4     16    100GB   GPU 1   K8s Worker +GPU 1
  (juju k8s\#2)       10.0.0.0/16 dhcp                  4     16    100GB   GPU 1   K8s Worker +GPU 1
```
## Login information
...
## Software versions
  ...
  ------------ ------------------------------ -- --
  Ubuntu       18.04 LTS                         
  juju         2.7.6-bionic-amd64                
  Kubernetes   v1.15.11                          
  kubeflow     1.0                               
  ESXi         VMware ESXi, 6.7.0, 13006603      
  vCenter      6.7.0.30000                       

## Setup (juju Client)

1.  Create Virtual Machine
  2 Core/ 4GB mem / 32GB disk
  
2.  Ubuntu 18.04 LTS Install
...
|                      | Manual                             |
|                      |                                    |
|                      | 15.210.188.0/22 (Subnet)           |
|                      |                                    |
|                      | 15.210.188.130(Address)\           |
|                      | 15.210.188.1 (Gateway)             |
|                      |                                    |
|                      | ens192                             |
|                      |                                    |
|                      | dhcpv4                             |
+----------------------+------------------------------------+
| Proxy                | http://16.242.55.11:8080/          |
+----------------------+------------------------------------+
| Mirror address       | (default)                          |
+----------------------+------------------------------------+
| Filesystem           | Use An Entire Disk\                |
|                      | /dev/sda 40.00GB                   |
+----------------------+------------------------------------+
| Username             | Hitp                               |
+----------------------+------------------------------------+
...
|                      | \[Disable\] Import SSH Identity    |
+----------------------+------------------------------------+
| Feature Server Setup | \[Enable\] Juju                    |
+----------------------+------------------------------------+
|                      |                                    |
+----------------------+------------------------------------+

3.  Add entry hitp user to sudoers
...
5.  Set proxy settings (\~/.bashrc)
```
+----------------------------------------------------------------------+
| HTTP_PROXY=http://16.242.55.11:8080                                 |
|                                                                      |
| https_proxy=http://16.242.55.11:8080                                |
|                                                                      |
| http_proxy=http://16.242.55.11:8080                                 |
|                                                                      |
| no_proxy=localhost, 127.0.0.1, .vsphere.local , 10.0.0.0/16         |
| ,172.16.0.0/16                                                       |
|                                                                      |
| NO_PROXY=localhost, 127.0.0.1, .vsphere.local , 10.0.0.0/16         |
| ,172.16.0.0/16                                                       |
...
```
+----------------------------------------------------------------------+
| hitp\@ubu-c1:\~\$ juju add-cloud \--local                            |
|                                                                      |
| Cloud Types                                                          |
|                                                                      |
| lxd                                                                  |
...
|                                                                      |
| Enter the vCenter address or URL: vcenter.vsphere.local              |
|                                                                      |
| Enter datacenter name: Hewlett-Packard                               |
|                                                                      |
| Enter another datacenter? (y/N): N                                   |
|                                                                      |
| Cloud \"vsphere\" successfully added to your local client.           |
|                                                                      |
| You will need to add a credential for this cloud (\`juju             |
| add-credential vsphere\`)                                            |
|                                                                      |
| before you can use it to bootstrap a controller (\`juju bootstrap    |
| vsphere\`) or                                                        |
|                                                                      |
| to create a model (\`juju add-model \<your model name\> vsphere\`).  |
+======================================================================+
| hitp\@ubu-c1:\~\$ juju add-credential vsphere                        |
|                                                                      |
| This operation can be applied to both a copy on this client and to   |
| the one on a controller.                                             |
|                                                                      |
| No current controller was detected and there are no registered       |
| controllers on this client: either bootstrap one or register one.    |
|                                                                      |
| Enter credential name: vsphere-cred                                  |
|                                                                      |
| Regions                                                              |
|                                                                      |
| Hewlett-Packard                                                      |
...
|                                                                      |
| Credential \"vsphere-cred\" added locally for cloud \"vsphere\".     |
+----------------------------------------------------------------------+
|                                                                      |
+----------------------------------------------------------------------+
```
...
+---------------------------------------------------------------------+
| ~~apt-http-proxy: http://10.0.0.254:3128~~                          |
|                                                                     |
| ~~apt-https-proxy: http://10.0.0.254:3128~~                         |
|                                                                     |
| ~~apt-ftp-proxy: http://10.0.0.254:3128~~                           |
|                                                                     |
| ~~http-proxy: http://10.0.0.254:3128~~                              |
|                                                                     |
| ~~https-proxy: http://10.0.0.254:3128~~                             |
|                                                                     |
| ~~ftp-proxy:~~ [~~http://10.0.0.254:3128~~](http://10.0.0.254:3128) |
|                                                                     |
| primary-network: InternalNetworkVM                                  |
|                                                                     |
...
+----------------------------------------------------------------------+
| hitp\@ubu-c1:\~\$ juju bootstrap vsphere vsphere-00 \--config        |
| bootstrap.conf \--show-log                                           |
|                                                                      |
| 05:04:19 INFO juju.cmd supercommand.go:83 running juju \[2.7.5 gc    |
| go1.10.4\]                                                           |
|                                                                      |
| 05:04:21 INFO cmd authkeys.go:114 Adding contents of                 |
| \"/home/hitp/.local/share/juju/ssh/juju\_id\_rsa.pub\" to            |
| authorized-keys                                                      |
|                                                                      |
| Creating Juju controller \"vsphere-00\" on vsphere/Hewlett-Packard   |
|                                                                      |
| 05:04:21 INFO juju.cmd.juju.commands bootstrap.go:825 combined       |
| bootstrap constraints:                                               |
|                                                                      |
| 05:04:21 INFO cmd bootstrap.go:351 Loading image metadata            |
|                                                                      |
| Looking for packaged Juju agent version 2.7.5 for amd64              |
|                                                                      |
| 05:04:21 INFO juju.environs.bootstrap tools.go:72 looking for        |
| bootstrap agent binaries: version=2.7.5                              |
|                                                                      |
| 05:04:26 INFO juju.environs.bootstrap tools.go:74 found 1 packaged   |
| agent binaries                                                       |
|                                                                      |
| 05:04:26 INFO cmd bootstrap.go:515 Starting new instance for initial |
| controller                                                           |
|                                                                      |
| 05:04:26 WARN juju.provider.vmware client.go:115 empty string passed |
| as vm-folder, using Datacenter root folder instead                   |
|                                                                      |
| Launching controller instance(s) on vsphere/Hewlett-Packard\...      |
|                                                                      |
| 05:04:35 INFO juju.provider.vmware createvm.go:487 selecting         |
| datastore datastore2                                                 |
|                                                                      |
| 05:04:35 WARN juju.provider.vmware client.go:115 empty string passed |
| as vm-folder, using Datacenter root folder instead                   |
|                                                                      |
| 05:04:36 INFO juju.provider.vmware createvm.go:260 Streaming VMDK    |
| from                                                                 |
| http://cloud-images.ubuntu.com/releases/server/r                     |
| eleases/onic/release-20200407/ubuntu-18.04-server-cloudimg-amd64.ova |
| to                                                                   |
| https://pesxikn                                                      |
| l02.vsphere.local/nfc/528a7523-562b-3bd3-6b2f-8c9d9d30da/disk-0.vmdk |
|                                                                      |
| 05:08:11 INFO juju.provider.vmware environ\_broker.go:94 started     |
| instance \"juju-a9c142-0\"                                           |
|                                                                      |
| \- juju-a9c142-0 (arch=amd64 mem=3.5G)                               |
|                                                                      |
| 05:08:11 INFO juju.environs.bootstrap bootstrap.go:856 newest        |
| version: 2.7.5                                                       |
|                                                                      |
| 05:08:11 INFO juju.environs.bootstrap bootstrap.go:871 picked        |
| bootstrap agent binary version: 2.7.5                                |
|                                                                      |
| Installing Juju agent on bootstrap instance                          |
|                                                                      |
| Unable to fetch Juju GUI info: error fetching simplestreams          |
| metadata: \"content-download\" data not found                        |
|                                                                      |
| Waiting for address                                                  |
|                                                                      |
| Attempting to connect to fe80::250:56ff:fe0e:e9b9:22                 |
|                                                                      |
| Attempting to connect to 15.210.188.97:22                            |
|                                                                      |
| Attempting to connect to 15.210.188.96:22                            |
|                                                                      |
| Attempting to connect to fe80::250:56ff:fe1e:c0b4:22                 |
|                                                                      |
| Connected to 15.210.188.96                                           |
|                                                                      |
| 05:12:49 INFO juju.cloudconfig userdatacfg\_unix.go:565 Fetching     |
| agent: curl -sSfw \'agent binaries from %{url\_effective} download:  |
| HTTP %{http\_code}; time %{time\_total}s; size %{size\_download}     |
| bytes; speed %{speed\_download} bytes/s \' \--retry 10 \--proxy      |
| htt//16.174.16.11:8080 \--noproxy                                    |
| localhost,15.210.188.92,vcenter.vsphere.local,pesxiknl02             |
| .vsphere.local,15.210.188.94,15.210.188.955.210.188.96,15.210.188.97 |
| -o \$bin/tools.tar.gz                                                |
| \<\[https://stream                                                   |
| s.canonical.com/juju/tools/agent/2.7.5/juju-2.7.5-ubuntu-amd64.t\]\> |
|                                                                      |
| Running machine configuration script\...                             |
|                                                                      |
| Bootstrap agent now started                                          |
|                                                                      |
| 05:19:07 INFO juju.juju api.go:302 API endpoints changed from \[\]   |
| to \[15.210.188.97:17070 15.210.188.96:17070\]                       |
|                                                                      |
| Contacting Juju controller at 15.210.188.97 to verify                |
| accessibility\...                                                    |
|                                                                      |
| 05:19:07 INFO juju.juju api.go:67 connecting to API addresses:       |
| \[15.210.188.97:17070 15.210.188.96:17070\]                          |
|                                                                      |
| 05:19:19 INFO juju.api apiclient.go:624 connection established to    |
| \"wss:                                                               |
| //15.210.188.96:17070/model/704c1ac5-b5ac-4921-8233-4fd7430383/api\" |
|                                                                      |
| Bootstrap complete, controller \"vsphere-00\" is now available       |
|                                                                      |
| Controller machines are in the \"controller\" model                  |
|                                                                      |
| Initial model \"default\" added                                      |
|                                                                      |
| 05:19:19 INFO cmd supercommand.go:525 command finished               |
|                                                                      |
| hitp\@ubu-c1:\~\$ juju show-controller                               |
|                                                                      |
| vsphere-00:                                                          |
|                                                                      |
| details:                                                             |
|                                                                      |
| uuid: 087688a3-0cba-4edb-8eed-a2e45e12d8e8                           |
|                                                                      |
| controller-uuid: 087688a3-0cba-4edb-8eed-a2e45e12d8e8                |
|                                                                      |
| api-endpoints: \[\'15.210.188.96:17070\', \'15.210.188.97:17070\'\]  |
|                                                                      |
| cloud: vsphere                                                       |
|                                                                      |
| region: Hewlett-Packard                                              |
|                                                                      |
| agent-version: 2.7.5                                                 |
|                                                                      |
| agent-git-commit: 3a6aa80a6e26bf3b05dd19206d2a4dae7935332e           |
|                                                                      |
| controller-model-version: 2.7.5                                      |
|                                                                      |
| mongo-version: 3.6.3                                                 |
|                                                                      |
| ca-fingerprint:                                                      |
| D0:2E:B7:11:4A:D8:E2:4C:D6:                                          |
| 15:2D:AC:43:7F:E5:B9:19:3F:FC:E6:B2:A3:6A:49:BF:5A:79:37:8C:17:9A:53 |
|                                                                      |
| ca-cert: \|                                                          |
|                                                                      |
| \-\-\-\--BEGIN CERTIFICATE\-\-\-\--                                  |
|                                                                      |
| MIIErTCCAxWgAwIBAgIVALA4ox982ZCcufUKn9liPIJq8jHDMA0GCSqGSIb3DQEB     |
|                                                                      |
| CwUAMG4xDTALBgNVBAoTBGp1anUxLjAsBgNVBAMMJWp1anUtZ2VuZXJhdGVkIENB     |
|                                                                      |
| IGZvciBtb2RlbCAianVqdS1jYSIxLTArBgNVBAUTJDg3YmI2NjNmLWY5Y2EtNGRi     |
|                                                                      |
| MS04NTgwLTAyYTk1N2YzNDRkNDAeFw0yMDA0MDMwNTA0MjFaFw0zMDA0MTAwNTA0     |
|                                                                      |
| MTlaMG4xDTALBgNVBAoTBGp1anUxLjAsBgNVBAMMJWp1anUtZ2VuZXJhdGVkIENB     |
|                                                                      |
| IGZvciBtb2RlbCAianVqdS1jYSIxLTArBgNVBAUTJDg3YmI2NjNmLWY5Y2EtNGRi     |
|                                                                      |
| MS04NTgwLTAyYTk1N2YzNDRkNDCCAaIwDQYJKoZIhvcNAQEBBQADggGPADCCAYoC     |
|                                                                      |
| ggGBAMLhJWxbIvaCF4NJBBSqpPu0qxPcrE4J2xog5ML2HCIIE9i81gZ2aU99g+82     |
|                                                                      |
| YBO95qfsnTMQmbq3J49uHcsh7LD/zKRQ2NIRAkW4Zt5gTZ/n4lzWCx2j6lK3muKv     |
|                                                                      |
| WhXDl6NtMqLJueW+nK+UzIW+tjrL+dZeUihmrKVnJC9O5Zt/gF+ui1dZ5CpTrldW     |
|                                                                      |
| qwpVmrngiIyH9dGjsbTgbT4ejGmjSgyqvGbTyIkZCZeyOcov8r/O3yJChkfHYW7F     |
|                                                                      |
| Ja5NG4jR/XRqpOt2oYDDAp3sUeYt8D3uT8W13r5hwU77nFXPTzzQwhhVKAY07HdM     |
|                                                                      |
| 6zIDu8imOTypdTguRG9V3EGyi7qASCpVyGk58nf/iwfxhwo0ORy0QmEp3OLVkVE3     |
|                                                                      |
| Vi4m8J987/Lqsua1SA4wmB08I2E37vcXRvc+A5P4FB3MRt7BGsNs8GhTdIGQVY1G     |
|                                                                      |
| Siwi8eI6vxkUBtC3RgAxtVBYhIRjUk9zuRpj4g7v+YayUN2nJ+raa2v1LTB+kfzm     |
|                                                                      |
| gmQrXwIDAQABo0IwQDAOBgNVHQ8BAf8EBAMCAqQwDwYDVR0TAQH/BAUwAwEB/zAd     |
|                                                                      |
| BgNVHQ4EFgQU/wqgzjfw3c6TDbOb6/D6WdzEDlMwDQYJKoZIhvcNAQELBQADggGB     |
|                                                                      |
| ABZAzaNnjTBfA9H7e1vgMmCfWKWenSm3vveii3Eki7EUYsRH+BGJuOp6BnZ9l7Lm     |
|                                                                      |
| 5cRmqZevTX0cg4KlagvzcPODpAerwjwR9FoOlED0F5lUU9rjeVu3WVzCDS17PSAd     |
|                                                                      |
| XM98/3gOyPXZSKpfuGysZ2bzGxDY1C0yIjG8/QM1A3YRqPyZT7dGgVU0GeMxEbwc     |
|                                                                      |
| JRy+OZQllQuoaVKzGXT0aS0TVh5NoZn/792eppdnOUwXLnfqS4LL9aflPpyyAswn     |
|                                                                      |
| TbLmMJEiM2jt/bzWD+ZKOayHujqFspRKl6qfb2V+q4iScPiewrdIVX/XyfBM3G88     |
|                                                                      |
| lRbZcs+voe9h8rvBJHyRl0KAGgswmjOXNBHG0YxjTFlRGfjiw/i1YbkETbJdWVGP     |
|                                                                      |
| JRLhhMjHD4ZNWqlriQBlP2+K1OY8ixJF0kCbLRIogbkBjrI2mgBQlaBremskTlr4     |
|                                                                      |
| bbkQzcbJdWcykz573mjv5lD6iuoic9Z9STGN9fK/ucUtDX5aD4LQKDjOGadhE+Na     |
|                                                                      |
| uA==                                                                 |
|                                                                      |
| \-\-\-\--END CERTIFICATE\-\-\-\--                                    |
...
| \"0\":                                                               |
|                                                                      |
| instance-id: juju-a9c142-0                                           |
|                                                                      |
| models:                                                              |
|                                                                      |
| controller:                                                          |
|                                                                      |
| uuid: 98a0fe46-1c86-4f9a-862b-8ce641a9c142                           |
|                                                                      |
| model-uuid: 98a0fe46-1c86-4f9a-862b-8ce641a9c142                     |
|                                                                      |
| machine-count: 1                                                     |
|                                                                      |
| default:                                                             |
|                                                                      |
| uuid: 704c1ac5-b5ac-4921-8233-4fd755430383                           |
|                                                                      |
| model-uuid: 704c1ac5-b5ac-4921-8233-4fd755430383                     |
|                                                                      |
...
![](media/image3.png){width="6.1375in" height="3.7527777777777778in"}

7.  Create bundle.yaml

+----------------------------------------------------------------------+
| description: For demo purpose, 1 master + GPU workers Kubernetes     |
| cluster.                                                             |
|                                                                      |
| machines:                                                            |
|                                                                      |
...
+----------------------------------------------------------------------+
| hitp\@ubu-c1:\~\$ watch -c juju status \--color                      |
|                                                                      |
| Every 2.0s: juju status \--color ubu-c1.hitp.local: Sun Apr 12       |
| 12:31:10 2020                                                        |
|                                                                      |
| Model Controller Cloud/Region Version SLA Timestamp                  |
|                                                                      |
| controller vsphere-00 vsphere/Hewlett-Packard 2.7.5 unsupported      |
| 12:31:11Z                                                            |
|                                                                      |
| App Version Status Scale Charm Store Rev OS Notes                    |
|                                                                      |
| calico active 2 calico jujucharms 689 ubuntu                         |
|                                                                      |
| containerd active 2 containerd jujucharms 46 ubuntu                  |
|                                                                      |
...
| ubuntu                                                               |
|                                                                      |
| kubernetes-worker 1.15.11 active 1 kubernetes-worker jujucharms 588  |
| ubuntu exposed                                                       |
|                                                                      |
| Unit Workload Agent Machine Public address Ports Message             |
|                                                                      |
| easyrsa/0\* active idle 1 15.210.188.130 Certificate Authority       |
| connected.                                                           |
|                                                                      |
| etcd/0\* active idle 1 15.210.188.130 2379/tcp Errored with 0 known  |
| peers                                                                |
|                                                                      |
| kubeapi-load-balancer/0\* active idle 1 15.210.188.130 443/tcp       |
| Loadbalancer ready.                                                  |
|                                                                      |
| kubernetes-master/0\* waiting idle 1 15.210.188.130 6443/tcp Waiting |
| for 3 kube-system pods to start                                      |
|                                                                      |
| calico/1\* active idle 15.210.188.130 Calico is active               |
|                                                                      |
| containerd/1 active idle 15.210.188.130 Container runtime available  |
|                                                                      |
| kubernetes-worker/0\* active idle 2 15.210.188.132 80/tcp,443/tcp    |
| Kubernetes worker running.                                           |
|                                                                      |
| calico/0 active idle 15.210.188.132 Calico is active                 |
|                                                                      |
| containerd/0\* active idle 15.210.188.132 Container runtime          |
| available                                                            |
|                                                                      |
| Machine State DNS Inst id Series AZ Message                          |
|                                                                      |
| 0 started 15.210.188.97 juju-a9c142-0 bionic poweredOn               |
|                                                                      |
| 1 started 15.210.188.130 juju-a9c142-1 bionic poweredOn              |
+----------------------------------------------------------------------+
...
11. Add GPU device for the Node which is added in the previous step

![](media/image4.png){width="6.1375in" height="2.8090277777777777in"}

+----------------------------------------------------------------------+
| ubuntu\@juju-82ce5c-1:\~\$ lspci                                     |
|                                                                      |
...
| ...                                                                  |
|                                                                      |
| 03:00.0 Serial Attached SCSI controller: VMware PVSCSI SCSI          |
| Controller (rev 02)                                                  |
|                                                                      |
| 0b:00.0 Ethernet controller: VMware VMXNET3 Ethernet Controller (rev |
| 01)                                                                  |
|                                                                      |
| 13:00.0 3D controller: NVIDIA Corporation GP104GL \[Tesla P4\] (rev  |
| a1)                                                                  |
+----------------------------------------------------------------------+

12. Install kubectl with snap on juju client
